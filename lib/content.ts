  ...
  cards: [
    {
      ...
      groups: [
        ...
        { cat: "web", items: ["Hasta 2 cambios web/mes"] },
    ...
    },
    {
      ...
      groups: [
        ...
        { cat: "web", items: ["Hasta 4 cambios/mes + 1 landing/trimestre", "SEO on-page + local + 1 artículo/mes"] },
    ...
    },
    {
      ...
      inherits: "ACTIVE",
      groups: [
        { cat: "social", items: ["Hasta 5 canales", "24 posts/mes", "40 stories/mes", "Community management completo"] },
        ...
        { cat: "web", items: ["Web + landing pages (tope alto)", "SEO completo + técnico + link building + 3 artículos/mes"] },
